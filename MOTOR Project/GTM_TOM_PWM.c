...
#define PIN                 IfxGtm_TOM1_3N_TOUT6_P02_6_OUT          /* Pin which will drive the PWM          */
#define PWM_PERIOD          2                                       /* PWM period for the TOM                       */
...
void initGtmTomPwm(void)
{
    ...
    g_tomConfig.tom = PIN.tom;                                      /* Select the TOM depending on the LED          */
    g_tomConfig.tomChannel = PIN.channel;                           /* Select the channel depending on the LED      */
    g_tomConfig.period = PWM_PERIOD;                                /* Set the timer period                         */
    g_tomConfig.pin.outputPin = &PIN;                               /* Set the LED port pin as output               */
    g_tomConfig.synchronousUpdateEnabled = TRUE;                    /* Enable synchronous update                    */
    g_tomConfig.dutyCycle = 1;
    g_tomConfig.clock = 4; //fx clock look into
